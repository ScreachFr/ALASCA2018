...
public class ComputerMonitor extends fr.upmc.datacenter.hardware.tests.ComputerMonitor {
	...
	public ComputerMonitor(String computerURI, boolean active) throws Exception {
		super(computerURI, active, AbstractPort.generatePortURI(), AbstractPort.generatePortURI());
	}
	...
	public Map<ComputerMonitorPortTypes, String> getPortTypes() throws Exception {
		...
		result.put(ComputerMonitorPortTypes.STATIC_STATE_OUT, this.cssPort.getPortURI());
		result.put(ComputerMonitorPortTypes.DYNAMIC_STATE_OUT, this.cdsPort.getPortURI());
