...
public class ClassFactory {
	...
	public static Class<?> newConnector(Class<?> implementedInterface) throws NotFoundException, CannotCompileException {
		return newConnector(implementedInterface.getName() + "Connector" + (id++), AbstractConnector.class, implementedInterface);
	}
