package fr.upmc.components.extensions.synchronizers.delegates;
...
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.countDownLatch.CountDownLatchConnectionConnector;
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.countDownLatch.CountDownLatchConnector;
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.cyclicBarrier.CyclicBarrierConnectionConnector;
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.cyclicBarrier.CyclicBarrierConnector;
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.semaphore.SemaphoreConnectionConnector;
import fr.upmc.components.extensions.synchronizers.connectors.syncTools.semaphore.SemaphoreConnector;
...
import fr.upmc.components.extensions.synchronizers.ports.SynchronizerManagerClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueueConnectionClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueuePutClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.arrayBlockingQueue.ArrayBlockingQueueTakeClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.countDownLatch.CountDownLatchClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.countDownLatch.CountDownLatchConnectionClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.cyclicBarrier.CyclicBarrierClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.cyclicBarrier.CyclicBarrierConnectionClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.semaphore.SemaphoreClientOutboundPort;
import fr.upmc.components.extensions.synchronizers.ports.syncTools.semaphore.SemaphoreConnectionClientOutboundPort;
...
public class SynchronizerManagerDelegate
{
	...
	{
		throw new Exception("Opps: code need update!") ;
//		PortI port =
